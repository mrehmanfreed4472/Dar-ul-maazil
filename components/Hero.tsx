        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              >
                <Link href="/products">
                  <Button size="lg" className="gap-3 gradient-primary text-white font-semibold px-8 py-4 premium-shadow hover:premium-shadow-lg transition-all duration-300 relative overflow-hidden group">
                    <motion.div
              ...
              >
                <Link href="/contact">
                  <Button variant="outline" size="lg" className="gap-3 glass-effect border-primary/30 text-primary hover:bg-primary/10 font-semibold px-8 py-4 relative overflow-hidden group">
                    <motion.div
                      className="absolute inset-0 border border-primary/50 rounded opacity-0 group-hover:opacity-100"
                      animate={{
                        scale: [1, 1.05, 1]
                      }}
                      transition={{
            ...
            >
              {[
                ...
                return (
                  ...
                  >
                    <motion.div
                      className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center relative overflow-hidden"
                      whileHover={{
