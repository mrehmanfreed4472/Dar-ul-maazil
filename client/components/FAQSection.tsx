      ...
      questions: [
        {
          ...
          answer: isRTL() 
            ? "نقدم خدمات العزل المائي والحراري، وتوريد مواد البناء عالية الجودة، وخدمات التركيب الاحترافية، والاستشارات الهندسية المتخصصة في مجال العزل."
        ...
        },
        {
          ...
          answer: isRTL() 
            ? "لدينا أكثر من 15 سنة من الخبرة في مجا�� مواد البناء والعزل، وقد نفذنا أكثر من 1000 مشروع ناجح في جميع أنحاء الإمارات."
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: isRTL() 
            ? "يمكنك الحصول على عرض أسعار مجاني عبر موقعنا الإلكتروني، أو الاتصال بنا مباشرة، أو زيارة معرضنا. نقدم استشارة مجانية وعرض أسعار مفصل خلال 24 ساعة."
        ...
        },
        {
          ...
          answer: isRTL() 
            ? "نعم، لدينا برنامج خاص للمقاولين والمطورين مع أسعار تفضيلية وشروط دفع مرنة وخدمة توصيل مجانية للمشاريع الكبيرة."
      ...
      questions: [
        {
          ...
          answer: isRTL() 
            ? "نعم، لدينا فريق من الفنيين المتخصصين والمعتمدي�� لتركيب جميع أنواع العزل. نضمن جودة التركيب ونقدم ضمان على العمالة."
        ...
        },
        {
          ...
          answer: isRTL() 
            ? "نعم، نقدم خدمات الصيانة الدورية والطارئة لجميع أنواع العزل. لدينا فريق صيانة متخصص متاح 24/7 للح��لات الطارئة."
